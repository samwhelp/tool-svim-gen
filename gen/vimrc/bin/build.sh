...
svim_build_all () {
	...
	# colorscheme
	svim_apd_conf_file "ColorSchemePick.vim" "$file_path"
	svim_apd_conf_file "ColorSchemePlug.vim" "$file_path"
	...
	# pack
	svim_build_pack "$file_path"

	# config
	svim_apd_boot_file "ConfigInControl.vim" "$file_path"

	# plugin manager
	svim_apd_boot_file "PluginInControl.vim" "$file_path"
	svim_apd_boot_file "PluginManager.vim" "$file_path"

	# main
	svim_apd_boot_file "ColorSchemeUse.vim" "$file_path"
	svim_apd_boot_file "Main.vim" "$file_path"
